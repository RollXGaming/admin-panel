		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				...
				<?php if(!isset($hideheader) || !$hideheader){?>
					<?php $this->load->view('layouts/agent/header',$view)?>
				<?php } ?>
				<!--end::Header-->
				<!--begin::Wrapper-->
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper" style="<?php if(isset($hideheader) &&$hideheader){echo 'margin-top:40px!important;';}?> <?php if(isset($hidesidebar) &&$hidesidebar){echo 'margin-left:10px!important;';}?>">
					...
					<?php if(!isset($hidesidebar) || !$hidesidebar){?>
						<?php 
						$this->load->view('layouts/agent/sidebar',$view);
						?>
					<?php } ?>
					<?=showFlashData()?>
					...
					<?php $this->load->view('layouts/agent/modal',$view)?>
					<?php $this->load->view('layouts/agent/footer',$view)?>
				</div>
				<!--end::Wrapper-->
			</div>
