	...
	<div class="app-sidebar-menu flex-column-fluid">
		<div id="kt_app_sidebar_menu_wrapper" class="hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px">
			<div class="menu menu-column menu-rounded menu-sub-indention fw-bold px-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
				<!--begin:Menu item-->
				<div class="menu-item">
				    <a class="menu-link" href="<?=site_url('master/dashboard')?>" data-activeurl="dashboard">
				...
				<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				    ...
				    <div class="menu-sub menu-sub-accordion">
				        <div class="menu-item">
				            <a class="menu-link" href="<?=site_url('master/agent/list')?>" data-activeurl="agent/list">
				        ...
				        <div class="menu-item">
				            <a class="menu-link" href="<?=site_url('master/agent/settings')?>" data-activeurl="agent/settings">
				                <span class="menu-bullet">
				                    <span class="bullet bullet-dot"></span>
				                </span>
				                <span class="menu-title">Agent Setting</span>
				            </a>
				        </div>
				    </div>
				</div>
				...
				<!--begin:Menu item-->
				<div class="menu-item">
				    <a class="menu-link" href="<?=site_url('master/agent/balances')?>" data-activeurl="agent/balances">
				        <span class="menu-icon">
				            <i class="ki-solid ki-wallet fs-2"></i>
				        </span>
				        <span class="menu-title">Agent Balance</span>
				    </a>
				</div>
				<!--end:Menu item-->
				...
				<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				    ...
				    <div class="menu-sub menu-sub-accordion">
				        <div class="menu-item">
				            <a class="menu-link" href="<?=site_url('master/report/agent_daily')?>" data-activeurl="report/agent_daily">
				                <span class="menu-bullet">
				                    <span class="bullet bullet-dot"></span>
				                </span>
				        ...
				        <div class="menu-item">
				            <a class="menu-link" href="<?=site_url('master/report/agent_win_lose')?>" data-activeurl="report/agent_win_lose">
				                <span class="menu-bullet">
				                    <span class="bullet bullet-dot"></span>
				                </span>
				        ...
				        <div class="menu-item">
				            <a class="menu-link" href="<?=site_url('master/report/game_win_lose')?>" data-activeurl="report/game_win_lose">
				                <span class="menu-bullet">
				                    <span class="bullet bullet-dot"></span>
				                </span>
				        ...
				        <div class="menu-item">
				            <a class="menu-link" href="<?=site_url('master/report/player_win_lose')?>" data-activeurl="report/player_win_lose">
				                <span class="menu-bullet">
				                    <span class="bullet bullet-dot"></span>
				                </span>
				        ...
				        <div class="menu-item">
				            <a class="menu-link" href="<?=site_url('master/report/agent_invoice')?>" data-activeurl="report/agent_invoice">
				                <span class="menu-bullet">
				                    <span class="bullet bullet-dot"></span>
				                </span>
				...
				<!--begin:Menu item-->
				<div class="menu-item">
				    <a class="menu-link" href="<?=site_url('master/setting/games')?>" data-activeurl="setting/games">
				        <span class="menu-icon">
				...
				<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				    ...
				    <div class="menu-sub menu-sub-accordion">
				        <div class="menu-item">
				            <a class="menu-link" href="<?=site_url('master/security/ip')?>" data-activeurl="security/ip">
				                <span class="menu-bullet">
				                    <span class="bullet bullet-dot"></span>
				                </span>
				        ...
				        <div class="menu-item">
				            <a class="menu-link" href="<?=site_url('master/security/activitylogs')?>" data-activeurl="security/activitylogs">
				                <span class="menu-bullet">
				                    <span class="bullet bullet-dot"></span>
				                </span>
				...
				<!--begin:Menu item-->
				<div class="menu-item">
				    <a class="menu-link" href="<?=site_url('master/account/mybalance')?>" data-activeurl="account/mybalance">
				        <span class="menu-icon">
				...
				<!--begin:Menu item-->
				<div class="menu-item">
				    <a class="menu-link" href="<?=site_url('master/staff/list')?>" data-activeurl="staff/list">
				        <span class="menu-icon">
		...
		<div class="">
			...
			<div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-overflow="true" data-kt-menu-placement="top-start">
				...
				<div class="d-flex flex-column align-items-start justify-content-center ms-3">
					...
					<span class="badge badge-primary">MASTER AGENT</span>
				</div>
				<!--end::Name-->
			</div>
			<!--end::User info-->
