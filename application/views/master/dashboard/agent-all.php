            ...
            <div class="col-md-3 d-flex align-items-stretch">
                <div class="card w-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h6>Total Agent Balance</h6>
                            <p class="mb-0">Rp 12,345,000</p>
                        </div>
                    </div>
                </div>
            </div>       
        ...
        <div class="row g-3 mt-4">
            ...
            <div class="col-md-3 d-flex align-items-stretch">
                <div class="card w-100">
                    <div class="card-body d-flex align-items-center">
                        <div class="symbol symbol-40px me-3 bg-light-danger">
                            <i class="fas fa-money-bill-wave fs-4 text-danger"></i>
                        </div>
                        <div>
                            <h6>Win/Lose</h6>
                            <p class="mb-0">All: -Rp 3,654,740</p>
                            <p class="mb-0 text-success">Master Agent Share: -Rp 500,000</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 d-flex align-items-stretch">
                <div class="card w-100">
                    <div class="card-body d-flex align-items-center">
                        <div class="symbol symbol-40px me-3 bg-light-warning">
                            <i class="fas fa-eye fs-4 text-warning"></i>
                        </div>
                        <div>
                            <h6>Watchlist</h6>
                            <p class="mb-0">MCOGAE41134</p>
                            <h5 class="fw-bold text-primary">191,095,836</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card h-100">
                    <div class="card-header">
                        <h3 class="card-title">Agent Win/Loss Summary</h3>
                    </div>
                    <div class="card-body">
