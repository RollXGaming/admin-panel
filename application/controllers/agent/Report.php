...
class Report extends MY_Controller {
	...
	public function agent_win_lose() {
        ...
        $view['content']=$this->load->view('agent/report/agent-win-lose', $view,true);
    ...
    public function player_win_lose() {
        ...
        $view['content']=$this->load->view('agent/report/player-win-lose', $view,true);
        $this->load->view('layouts/agent/master', ['view'=>$view]);
    }
    public function game_win_lose() {
        ...
        $view['content']=$this->load->view('agent/report/game-win-lose', $view,true);
        $this->load->view('layouts/agent/master', ['view'=>$view]);
    }
    public function agent_daily() {
        ...
        $view['content']=$this->load->view('agent/report/agent-daily', $view,true);
        $this->load->view('layouts/agent/master', ['view'=>$view]);
    }
    public function agent_invoice() {
        ...
        $view['content']=$this->load->view('agent/report/agent-invoice', $view,true);
        $this->load->view('layouts/agent/master', ['view'=>$view]);
    }
